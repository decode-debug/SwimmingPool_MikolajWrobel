...
def test_Timetable_get_Data():
    ...
    timetable.table()
    data = {
       "reservation_num": [1, 1, 1, 1, 1, 2, 3, 4, 2],
       "client's_id": ["500005", "580003", "670003", "720009", "080008", "080008", "080008", "080008", "500005"],
       "starting_hour": ["2024-11-04 11:00:00", "2024-11-04 09:00:00", "2024-11-04 09:00:00", "2024-11-04 09:00:00", "2024-12-04 09:00:00", "2024-12-04 09:00:00", "2024-12-08 09:00:00", "2024-12-10 09:00:00", "2024-12-08 12:00:00"],
       "ending_hour": ["2024-11-04 13:00:00", "2024-11-04 11:00:00", "2024-11-04 11:00:00", "2024-11-04 11:00:00", "2024-11-04 11:00:00", "2024-12-04 11:00:00", "2024-12-08 11:00:00", "2024-12-10 11:00:00", "2024-12-08 15:00:00"],
       "track": [[2], [6], [3], [1], [5, 6], [4], [1], [1, 2], [1]],
       "people_swimming": [1, 1, 1, 1, 10, 5, 5, 10, 1]
    }
...
def test_TimeTable_filtered():
    timetable = TimeTable("Maly")
    filtered_Table = {
        'people_swimming': {0: 1, 8: 1},
        'ending_hour': {0: '2024-11-04 13:00:00', 8: '2024-12-08 15:00:00'},
        'track': {0: [2], 8: [1]},
        'starting_hour': {0: '2024-11-04 11:00:00', 8: '2024-12-08 12:00:00'},
        "client's_id": {0: '500005', 8: '500005'},
        'reservation_num': {0: 1, 8: 2}
    }
...
def test_TimeTable_book():
    ...
    data = {
       "reservation_num": [1, 1, 1, 1, 1, 2, 3, 4, 2, 1],
       "client's_id": ["500005", "580003", "670003", "720009", "080008", "080008", "080008", "080008", "500005", "570002"],
       "starting_hour": ["2024-11-04 11:00:00", "2024-11-04 09:00:00", "2024-11-04 09:00:00", "2024-11-04 09:00:00", "2024-12-04 09:00:00", "2024-12-04 09:00:00", "2024-12-08 09:00:00", "2024-12-10 09:00:00", "2024-12-08 12:00:00", "2024-11-04 11:00:00"],
       "ending_hour": ["2024-11-04 13:00:00", "2024-11-04 11:00:00", "2024-11-04 11:00:00", "2024-11-04 11:00:00", "2024-11-04 11:00:00", "2024-12-04 11:00:00", "2024-12-08 11:00:00", "2024-12-10 11:00:00", "2024-12-08 15:00:00", "2024-11-04 11:00:00"],
       "track": [[2], [6], [3], [1], [5, 6], [4], [1], [1, 2], [1], [4]],
       "people_swimming": [1, 1, 1, 1, 10, 5, 5, 10, 1, 1]
    }
    assert timetable.get_Data == data
